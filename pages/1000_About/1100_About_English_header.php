			...
			<div class="navbar-collapse collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item ml-lg-3<?= $_GET['MENU']=='Intro'?' active':'' ?>">
						<a class="nav-link" href="/About/English/Intro">Introduction</a>
					</li>
					<li class="nav-item ml-lg-3<?= $_GET['MENU']=='Marketing'?' active':'' ?>">
						<a class="nav-link" href="/About/English/Marketing">Foreigners PR &amp; Marketing</a>
					</li>
					<li class="nav-item ml-lg-3">
						<a class="nav-link" href="/About/Korean">한국어</a>
					</li>
